...
class AnimalTests(unittest.TestCase):
    def test_string(self):
        # Arrange
        animal.Animal.count = 4
        expected_result = "Id: 005, Name: Felix, Species: Cat, Colour: BROWN, Limb Count: 4"
    ...
    def test_dog_initialiser(self):
        # Arrange
        animal.Animal.count = 4
        expected_result = "Id: 005, Name: Felix, Species: Dog, Colour: ORANGE, Limb Count: 4, Tail Length: 0.75"
